...
( function( window, document, polymer, sinon, chai ) {
  ...
  var expect = chai.expect,
    ...
    testingWrapper = document.getElementById( "ed-mini-player-test-wrapper" ) ||
      ( function() {
    ...
    suite( "Life Cycle", function() {
      ...
      test( "ready: can create from document.createElement", function() {
        var createdSpy = sinon.spy(
          polymer.getRegisteredPrototype( "ed-mini-player" ),
          "ready"
        );

        expect( document.createElement( "ed-mini-player" ) )
          .to.have.property( "outerHTML" )
          .that.is.a( "string" )
          .and.equals( "<ed-mini-player></ed-mini-player>" );
      ...
      test( "attached: can be added to another DOM Element", function() {
        var newElement = document.createElement( "ed-mini-player" ),
