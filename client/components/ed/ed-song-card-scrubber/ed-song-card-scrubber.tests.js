...
( function( window, document, polymer, sinon, chai ) {
  ...
  // get wrapper from document or for karma, create a new div and append it to the DOM
    testingWrapper = document.getElementById( "ed-song-card-scrubber-test-wrapper" ) ||
      ( function() {
  ...
  suite( "<ed-song-card-scrubber>", function() {
    suite( "Life Cycle", function() {
      ...
      test( "ready: can create from document.createElement", function() {
        var createdSpy = sinon.spy(
          polymer.getRegisteredPrototype( "ed-song-card-scrubber" ),
          "ready"
        );

        expect( document.createElement( "ed-song-card-scrubber" ) )
          .to.have.property( "outerHTML" )
          .that.is.a( "string" )
          .and.equals( "<ed-song-card-scrubber></ed-song-card-scrubber>" );
      ...
      test( "attached: can be added to another DOM Element", function() {
        var edScrubber = document.createElement( "ed-song-card-scrubber" ),
    ...
    suite( "Attributes and Properties", function() {
      suite( "Min", function() {
        ...
        test( "can be set via \"setAttribute\"", function() {
          ...
          expect( edScrubber )
            .to.have.property( "outerHTML" )
            .that.equals( "<ed-song-card-scrubber min=\"5\"></ed-song-card-scrubber>" );
        });
      ...
      suite( "Max", function() {
        ...
        test( "can be set via \"setAttribute\"", function() {
          ...
          expect( edScrubber )
            .to.have.property( "outerHTML" )
            .that.equals( "<ed-song-card-scrubber max=\"50\"></ed-song-card-scrubber>" );
        });
      ...
      suite( "Format", function() {
        ...
        test( "can be set via \"setAttribute\"", function() {
          ...
          expect( edScrubber )
            .to.have.property( "outerHTML" )
            .that.equals( "<ed-song-card-scrubber format=\"time\"></ed-song-card-scrubber>" );
        });
      ...
      suite( "Type", function() {
        ...
        test( "can be set via \"setAttribute\"", function() {
          ...
          expect( edScrubber )
            .to.have.property( "outerHTML" )
            .that.equals( "<ed-song-card-scrubber type=\"fill\"></ed-song-card-scrubber>" );
        });
